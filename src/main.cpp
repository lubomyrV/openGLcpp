...
int main()
{
    ...
    Shader ourShader( ((CURRENT_DIR+"/shaders/vshader.vert").c_str()) , ((CURRENT_DIR+"/shaders/fshader1.frag").c_str()) );
    ...
    glm::vec3 cubePositions[] = {
        ...
        glm::vec3( 1.5f,  2.0f, -2.2f),
        glm::vec3( 1.5f,  0.2f, -1.5f),
        glm::vec3(-1.8f,  1.0f, -1.7f)
    };
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //view  = glm::translate(view, glm::vec3(0.0f, 0.0f, cameraView));
